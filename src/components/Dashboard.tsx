...
interface DashboardData {
    ...
    patientVisit: number;
    shifts: {
        morning: { rn: number; nonRn: number; workload?: number; expect?: number; actual?: number; productivity?: number; hn?: number; rnOnly?: number; pn?: number; na?: number };
        afternoon: { rn: number; nonRn: number; workload?: number; expect?: number; actual?: number; productivity?: number; hn?: number; rnOnly?: number; pn?: number; na?: number };
        midnight: { rn: number; nonRn: number; workload?: number; expect?: number; actual?: number; productivity?: number; hn?: number; rnOnly?: number; pn?: number; na?: number };
    };
    workforce: { rn: number; nonRn: number; hn?: number; rnOnly?: number; pn?: number; na?: number };
...
const initialData: DashboardData = {
    ...
    patientVisit: 0,
    shifts: {
        morning: { rn: 0, nonRn: 0, workload: 0, expect: 0, actual: 0, productivity: 0, hn: 0, rnOnly: 0, pn: 0, na: 0 },
        afternoon: { rn: 0, nonRn: 0, workload: 0, expect: 0, actual: 0, productivity: 0, hn: 0, rnOnly: 0, pn: 0, na: 0 },
        midnight: { rn: 0, nonRn: 0, workload: 0, expect: 0, actual: 0, productivity: 0, hn: 0, rnOnly: 0, pn: 0, na: 0 }
    },
                                    ...
                                    <table className="w-full text-sm text-left">
                                        <thead className="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-600 font-semibold">
                                            <tr>
                                                ...
                                                <th className="px-4 py-3 text-center"><span className="text-teal-600">PN</span></th>
                                        ...
                                        <tbody className="divide-y divide-gray-100">
                                            <tr className="hover:bg-orange-50/50">
                                                ...
                                                <td className="px-4 py-3 text-center font-bold text-teal-600">{data.shifts.morning.pn || 0}</td>
                                            ...
                                            <tr className="hover:bg-blue-50/50">
                                                ...
                                                <td className="px-4 py-3 text-center font-bold text-teal-600">{data.shifts.afternoon.pn || 0}</td>
                                            ...
                                            <tr className="hover:bg-indigo-50/50">
                                                ...
                                                <td className="px-4 py-3 text-center font-bold text-teal-600">{data.shifts.midnight.pn || 0}</td>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {dept === 'IPD' && data.workforce.hn !== undefined ? (
                                        <div className="flex gap-3 text-xs flex-wrap">
                                            ...
                                            <span className="flex items-center gap-1"><span className="w-2 h-2 bg-teal-500 rounded-full"></span> PN: <strong>{data.workforce.pn}</strong></span>
                                ...
                                <div className="w-28 h-28 relative">
                                    {dept === 'IPD' && data.workforce.hn !== undefined ? (
                                        <SkillMixChart
                                            ...
                                            nonRn={data.workforce.nonRn}
                                            hn={data.workforce.hn}
                                            rnOnly={data.workforce.rnOnly}
                                            pn={data.workforce.pn}
                                            na={data.workforce.na}
                                        />
                                    ) : (
                                        <SkillMixChart rn={data.workforce.rn} nonRn={data.workforce.nonRn} />
                                    )}
                                </div>
                            </div>
                        </div>
